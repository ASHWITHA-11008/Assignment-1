...
\begin{align*}
\Pr(X=0) & = \Comb{4}{0}\times{\left({\frac{24}{30}}\right)}^4=0.409\\
\Pr(X=1) & = \Comb{4}{1}\times\left({\frac{6}{30}}\right)\times{\left({\frac{24}{30}}\right)}^3=0.409\\
\Pr(X=2) & = \Comb{4}{2}\times{\left({\frac{6}{30}}\right)}^2\times{\left({\frac{24}{30}}\right)}^2=0.154\\
\Pr(X=3) & = \Comb{4}{3}\times{\left({\frac{6}{30}}\right)}^3\times\left({\frac{24}{30}}\right)=0.02\\
